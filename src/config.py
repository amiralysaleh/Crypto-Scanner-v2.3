...
CRYPTOCURRENCIES = [
    ...
    "HOT-USDT", "COMP-USDT", "ZEC-USDT", "DASH-USDT", "LRC-USDT",
    "QTUM-USDT", "ICX-USDT", "ONT-USDT", "WAVES-USDT", "KSM-USDT",
    "CHR-USDT", "ANKR-USDT", "OCEAN-USDT", "IOST-USDT", "SC-USDT",
    "RSR-USDT", "DCR-USDT", "SYS-USDT", "GLMR-USDT", "BICO-USDT",
    "COTI-USDT", "SKL-USDT", "BAL-USDT", "LPT-USDT", "CELR-USDT",
    "DGB-USDT", "XYO-USDT", "API3-USDT", "OMG-USDT", "POWR-USDT",
    "SXP-USDT", "REQ-USDT", "NKN-USDT", "CTSI-USDT",
    "STPT-USDT", "FLUX-USDT", "AUDIO-USDT",
    "CVC-USDT", "SNT-USDT", "HIVE-USDT", "LOOM-USDT", "ARK-USDT",
    "RLC-USDT", "NMR-USDT", "SLP-USDT", "AGLD-USDT", "FORTH-USDT",
    "REI-USDT", "PHA-USDT", "AERGO-USDT", "CLV-USDT", "TRAC-USDT",
    "LTO-USDT", "MLN-USDT", "RIF-USDT", "GHST-USDT", "DUSK-USDT",
    "BAND-USDT", "ORBS-USDT", "UOS-USDT", "ERN-USDT", "MDT-USDT",
    "KMD-USDT", "WNCG-USDT", "QKC-USDT", "XMR-USDT", "FIL-USDT",
    "EOS-USDT", "KLAY-USDT", "ZRX-USDT", "SNX-USDT", "REN-USDT",
    "BNT-USDT", "STMX-USDT", "MTL-USDT", "SUSHI-USDT", "LUNA-USDT",
    "RUNE-USDT", "DYDX-USDT", "YFI-USDT", "CRV-USDT", "UMA-USDT",
    "FET-USDT", "RAY-USDT", "AKRO-USDT", "CKB-USDT", "ALPHA-USDT",
    "PERP-USDT", "LIT-USDT", "CTK-USDT", "BADGER-USDT", "C98-USDT",
    "DODO-USDT", "ELF-USDT", "FRONT-USDT", "GTC-USDT", "HNT-USDT",
    "IDEX-USDT", "JASMY-USDT", "KDA-USDT", "LINA-USDT", "MIR-USDT",
    "OGN-USDT", "POLS-USDT", "QNT-USDT", "REEF-USDT", "SFP-USDT",
    "TOMO-USDT", "SPELL-USDT", "ILV-USDT", "MOVR-USDT", "GLM-USDT",
    "AQT-USDT", "BLOK-USDT", "TVK-USDT", "ARB-USDT", "BCH-USDT",
    "IMX-USDT"
]
...
SCALPING_SETTINGS = {
    ...
    'min_score_threshold': 30,       # Increased threshold for higher quality
...
KLINE_SIZE = 500  # Ensure enough data for Ichimoku and lookbacks
